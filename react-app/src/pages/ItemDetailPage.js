...
class ItemDetailPage extends Component {
	...
	componentDidMount() {
		const sellersPath = 'http://localhost:8080/api/items/' + this.props.match.params.id + '/users';
		const itemPath = 'http://localhost:8080/api/items/' + this.props.match.params.id;
